package com.wikicoding.SprintTodoRestAPI.service.authservice;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.wikicoding.SprintTodoRestAPI.dto.authdtos.AuthRequestDTO;
...
import com.wikicoding.SprintTodoRestAPI.repository.authrepositories.TokenRepository;
import com.wikicoding.SprintTodoRestAPI.repository.authrepositories.UserRepository;
import com.wikicoding.SprintTodoRestAPI.repository.persistencemodels.authmodels.Role;
import com.wikicoding.SprintTodoRestAPI.repository.persistencemodels.authmodels.Token;
import com.wikicoding.SprintTodoRestAPI.repository.persistencemodels.authmodels.TokenType;
...
public class AuthenticationService {
    ...
    public AuthResponseDTO register(RegisterReqDTO request) {
        User user = new User(request.getUsername(),
                passwordEncoder.encode(request.getPassword()), Role.valueOf(request.getRole()));
